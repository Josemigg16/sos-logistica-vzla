...
| Router + Data | [TanStack Router](https://tanstack.com/router) + [TanStack Query](https://tanstack.com/query) |
...
- TanStack Router: type-safe, file-based, sin magia
...
**Client-side only:** En emergencias el backend puede caer. Una SPA estática se sirve desde CDN o localmente. La data crítica se cachea con TanStack Query.
